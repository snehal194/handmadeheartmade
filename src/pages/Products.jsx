...
const Products = () => {
  ...
  const categories = ["All", "Wedding", "Crochet", "Nature", "Cloth", "Wooden"];
  ...
  return (
    <section className="bg-[#FFF8F3] py-20   gap-10 px-6">
      <div className="mx-auto flex max-w-7xl">
        <div className="w-64 rounded-xl bg-white p-6 shadow mr-4">
          <input
            type="text"
      ...
      {visibleProducts < filteredProducts.length && (
        <div className="mt-10 flex justify-center">
          <button
            ...
            className="rounded-full bg-pink-500 px-6 py-3 text-white font-semibold hover:bg-pink-600"
          >
            Load More
          </button>
        </div>
